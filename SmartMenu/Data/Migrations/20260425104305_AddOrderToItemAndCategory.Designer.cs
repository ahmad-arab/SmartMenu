...
namespace SmartMenu.Data.Migrations
{
    ...
    [Migration("20260425104305_AddOrderToItemAndCategory")]
    partial class AddOrderToItemAndCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.Menu", b =>
                {
                    ...
                    b.Property<string>("CategoryCardThemeJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ItemCardThemeJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("ItemCardThemeKey")
                        .HasColumnType("int");

                    b.Property<string>("LableThemeJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("LableThemeKey")
                        .HasColumnType("int");

                    b.Property<string>("MenuThemeJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("MenuThemeKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.MenuCommandStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MenuStaffId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("MenuCommandId");

                    b.HasIndex("MenuStaffId");

                    b.ToTable("MenuCommandStaffs");
                });
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.MenuStaffTimeSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.Tenant", b =>
                {
                    ...
                    b.Property<int>("AllowedMenusCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.MenuCommandStaff", b =>
                {
                    b.HasOne("SmartMenu.Data.Entities.MenuCommand", "MenuCommand")
                        .WithMany("MenuCommandStaffs")
                        .HasForeignKey("MenuCommandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartMenu.Data.Entities.MenuStaff", "MenuStaff")
                        .WithMany("MenuCommandStaffs")
                        .HasForeignKey("MenuStaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MenuCommand");

                    b.Navigation("MenuStaff");
                });
            ...
            modelBuilder.Entity("SmartMenu.Data.Entities.MenuCommand", b =>
                {
                    b.Navigation("MenuCommandStaffs");
